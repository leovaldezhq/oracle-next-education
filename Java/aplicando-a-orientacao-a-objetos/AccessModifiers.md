Resolução de desafios propostos no curso de "Java: aplicando a Orientação a Objetos", da trilha de especialização em Back-End do programa ONE, aplicanco conceitos como modificadores de acesso public e private, import, this, getters e setters.
